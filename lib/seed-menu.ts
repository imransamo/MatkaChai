...
export const seedMenu: MenuCategoryWithItems[] = [
  {
    ...
    items: [
      ...
      { id: 'chai-3', category_id: 'cat-chai', name: 'Malai Badam Chai', description: 'Creamy chai finished with malai and almond.', price: 400, image_url: '/images/hero-matka-photo.png', badge: 'Favourite', is_signature: true, is_active: true, sort_order: 3 },
  ...
  },
  {
    ...
    is_active: true,
    items: [
      { id: 'cooler-1', category_id: 'cat-coolers', name: 'Mint Lemonade', description: 'Zesty lemon, fresh mint and ice.', price: 500, image_url: '/images/cooler-photo.png', badge: 'Refreshing', is_signature: true, is_active: true, sort_order: 1 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'fries-3', category_id: 'cat-fries', name: 'Matka Fries', description: 'Seasoned fries served Matka Chai style.', price: 400, image_url: '/images/fries-photo.png', badge: 'Signature', is_signature: true, is_active: true, sort_order: 3 },
      { id: 'fries-4', category_id: 'cat-fries', name: 'Loaded Fries', description: 'Cheesy, saucy and generously loaded.', price: 650, image_url: '/images/fries-photo.png', badge: 'Popular', is_signature: true, is_active: true, sort_order: 4 },
  ...
  },
  {
    ...
    is_active: true,
    items: [
      { id: 'main-1', category_id: 'cat-mains', name: 'Matka Chicken Biryani', description: 'Fragrant basmati rice and spiced chicken served in a matka.', price: 1200, image_url: '/images/biryani-photo.png', badge: 'Signature', is_signature: true, is_active: true, sort_order: 1 },
      ...
      { id: 'main-3', category_id: 'cat-mains', name: 'Matka Nalli Biryani', description: 'Rich beef nalli biryani for serious desi food lovers.', price: 1800, image_url: '/images/biryani-photo.png', badge: 'Chef Pick', is_signature: true, is_active: true, sort_order: 3 },
  ...
  },
  {
    ...
    is_active: true,
    items: [
      { id: 'rosh-1', category_id: 'cat-rosh', name: 'Lamb Rosh', description: 'Tender lamb in a clean, deeply comforting broth.', price: 1500, image_url: '/images/rosh-photo.png', badge: 'Signature', is_signature: true, is_active: true, sort_order: 1 },
