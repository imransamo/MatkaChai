...
('chai-1','cat-chai','Matka Chai','Our signature creamy doodh patti served in an earthen matka.',250,'/images/matka-chai-real-matka.webp','Signature',true,true,1),
('chai-2','cat-chai','Elachi Chai','Aromatic cardamom chai, rich and comforting.',300,'/images/elaichi-chai-real-matka.webp',null,false,true,2),
('chai-3','cat-chai','Malai Badam Chai','Creamy chai finished with delicate malai and almond slivers.',400,'/images/malai-badam-chai-real-matka.webp','Favourite',true,true,3),
('chai-4','cat-chai','Kashmiri Chai','Pink tea with a delicate nutty finish.',400,'/images/kashmiri-chai-real-matka.webp',null,false,true,4),
('chai-5','cat-chai','Chocolate Chai','A playful chocolate twist on classic chai.',400,'/images/chocolate-chai-real-matka.webp',null,false,true,5),
('chai-6','cat-chai','Green Tea','Light, clean and soothing.',250,'/images/green-tea-real-matka.webp',null,false,true,6),
