...
('chai-3','cat-chai','Malai Badam Chai','Creamy chai finished with malai and almond.',400,'/images/hero-matka-photo.png','Favourite',true,true,3),
...
('cooler-1','cat-coolers','Mint Lemonade','Zesty lemon, fresh mint and ice.',500,'/images/cooler-photo.png','Refreshing',true,true,1),
...
('fries-3','cat-fries','Matka Fries','Seasoned fries served Matka Chai style.',400,'/images/fries-photo.png','Signature',true,true,3),
('fries-4','cat-fries','Loaded Fries','Cheesy, saucy and generously loaded.',650,'/images/fries-photo.png','Popular',true,true,4),
...
('main-1','cat-mains','Matka Chicken Biryani','Fragrant basmati rice and spiced chicken served in a matka.',1200,'/images/biryani-photo.png','Signature',true,true,1),
('main-2','cat-mains','Matka Beef Biryani','Slow-cooked beef and aromatic basmati rice.',1500,null,null,false,true,2),
('main-3','cat-mains','Matka Nalli Biryani','Rich beef nalli biryani for serious desi food lovers.',1800,'/images/biryani-photo.png','Chef Pick',true,true,3),
...
('rosh-1','cat-rosh','Lamb Rosh','Tender lamb in a clean, deeply comforting broth.',1500,'/images/rosh-photo.png','Signature',true,true,1),
