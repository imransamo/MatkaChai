...
('chai-1','cat-chai','Matka Chai','Our signature creamy doodh patti served in an earthen matka.',250,'/images/chai.svg','Signature',true,true,1),
('chai-2','cat-chai','Elachi Chai','Aromatic cardamom chai, rich and comforting.',300,null,null,false,true,2),
('chai-3','cat-chai','Malai Badam Chai','Creamy chai finished with malai and almond.',400,'/images/chai.svg','Favourite',true,true,3),
...
('coffee-2','cat-coffee','Caramel Latte','Smooth latte with caramel sweetness.',650,null,null,false,true,2),
('coffee-3','cat-coffee','Mocha Latte','Espresso, milk and chocolate.',650,null,null,false,true,3),
('cooler-1','cat-coolers','Mint Lemonade','Zesty lemon, fresh mint and ice.',500,'/images/cooler.svg','Refreshing',true,true,1),
...
('fries-3','cat-fries','Matka Fries','Seasoned fries served Matka Chai style.',400,'/images/fries.svg','Signature',true,true,3),
('fries-4','cat-fries','Loaded Fries','Cheesy, saucy and generously loaded.',650,'/images/fries.svg','Popular',true,true,4),
...
('main-1','cat-mains','Matka Chicken Biryani','Fragrant basmati rice and spiced chicken served in a matka.',1200,'/images/biryani.svg','Signature',true,true,1),
('main-2','cat-mains','Matka Beef Biryani','Slow-cooked beef and aromatic basmati rice.',1500,null,null,false,true,2),
('main-3','cat-mains','Matka Nalli Biryani','Rich beef nalli biryani for serious desi food lovers.',1800,'/images/biryani.svg','Chef Pick',true,true,3),
...
('rosh-1','cat-rosh','Lamb Rosh','Tender lamb in a clean, deeply comforting broth.',1500,'/images/rosh.svg','Signature',true,true,1),
